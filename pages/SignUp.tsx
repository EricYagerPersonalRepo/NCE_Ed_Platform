...
export default function SignUp() {
    ...
    useEffect(()=>{
        const checkUserAuthenticationStatusOnLoad = async () => {
            ...
            signUpHooks.setUserSignedIn(isUserSignedIn);
        }
    
        checkUserAuthenticationStatusOnLoad()
            .catch(error => {
                console.error('Error checking authentication status:', error);
                signUpHooks.setUserSignedIn(false); // or handle the error as appropriate
        })
    },[])
    ...
    const handlePostTfaWorkflow = async () => {
        ...
        try {
            ...
            let birthdate = signUpHooks.birthday
            let email = username
