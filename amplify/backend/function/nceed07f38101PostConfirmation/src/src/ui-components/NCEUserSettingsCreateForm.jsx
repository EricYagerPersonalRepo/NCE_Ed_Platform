...
import { createNCEUserSettings } from "../graphql/mutations";
const client = generateClient();
export default function NCEUserSettingsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createNCEUserSettings.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "NCEUserSettingsCreateForm")}
      {...rest}
    >
      <SwitchField
