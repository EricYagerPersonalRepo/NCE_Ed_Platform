...
import { createInstructorBiography } from "../graphql/mutations";
const client = generateClient();
export default function InstructorBiographyCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createInstructorBiography.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "InstructorBiographyCreateForm")}
      {...rest}
    >
      <TextField
        label="Overview"
