...
import { getUserSettings, listStudentProfiles } from "../graphql/queries";
...
export default function UserSettingsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = userSettingsRecord
      ? { ...initialValues, ...userSettingsRecord, studentProfile }
      : initialValues;
  ...
  React.useEffect(resetStateValues, [userSettingsRecord, studentProfile]);
  const [
